...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.getRatesapi = function () {
        var _this = this;
        this._dataservice.getRates().subscribe(function (response) {
...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.getRates = function () {
        var _this = this;
        return this._http.get('/rates').map(function (result) { return _this.result = result.json().data; });
    };
    DataService.prototype.getFixer = function () {
        return this._http.get('https://api.fixer.io/latest')
            .map(function (res) { return res.json(); });
    };
    DataService.prototype.saveRates = function (ratesbody) {
